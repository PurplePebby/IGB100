...
public class TrajectoryPrediction : MonoBehaviour {
    ...
    private List<Vector3> SimulateArc() //A method happening via this List
    {
        ...
        Vector3 directionVector = transform.up; //INPUT launch direction (This Vector2 is automatically normalized for us, keeping it in low and communicable terms)
    ...
    //    Collider2D[] hits = Physics.OverlapCircleAll(position, _collisionCheckRadius); //Measure collision via a small circle at the latest position, dont continue simulating Arc if hit

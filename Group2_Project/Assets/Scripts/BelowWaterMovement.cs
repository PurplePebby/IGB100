...
#endif
	public class BelowWaterMovement : MonoBehaviour
	{
		[Header("Player")]
		...
		private void Move()
		{
			...
			//	friction = Mathf.Lerp(currentHorizontalSpeed, targetSpeed * inputMagnitude, Time.deltaTime * SpeedChangeRate);

			//	// round speed to 3 decimal places
			//	friction = Mathf.Round(friction * 1000f) / 1000f;
			//}
			//else
			//{
			//	friction = targetSpeed;
			//}
			...
			velocityVector = Vector3.Lerp(velocityVector, Vector3.zero, SpeedChangeRate * Time.deltaTime);
			
			//Vector3 targetVector = new Vector3(forwardSwim.x + strafeSwim.x, verticalSwim.y, forwardSwim.z + strafeSwim.z);
			

			// move the player
			_controller.Move(Vector3.Lerp(_controller.velocity, velocityVector, SpeedChangeRate * Time.deltaTime) * Time.deltaTime);			
		}
		...
		private void JumpAndGravity()
		{
			...
			if (_controller.velocity.y < _terminalVelocity)
			{
